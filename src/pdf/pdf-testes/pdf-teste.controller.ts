...
export class UsuariosController {
  ...
  async gerarPDFSingle(
    ...
    doc.moveDown();
    doc.font('Helvetica').fontSize(16).text(` Carga Instalada: ${prodistN.PotenciaInstalada}    -    Tensão de Atendimento: ${prodistN.TensaoDeAtendimento} `, 25, 300, { width: 500 });
    doc.moveDown();
    ...
    doc.moveDown();
    doc.font('Helvetica').fontSize(16).text(` Potência Instalada de geração: ${prodistN.PotenciaInstaladaGeral} `, 25, 375, { width: 500 });
    doc.moveDown();
